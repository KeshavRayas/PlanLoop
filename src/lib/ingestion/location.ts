...
const REMOTE_PATTERN =
  /\b(remote|worldwide|work from home|work-from-home|distributed|fully remote|100% remote|remote-first|remote first|india remote|remote india|remote apac|remote asia|apac remote|asia remote|remote - india|emea)\b/i;
const REMOTE_DASH_PATTERN = /\bremote\s*[-–]\s*(india|apac|asia)\b/i;
const REMOTE_PAREN_PATTERN = /\bremote\s*\((apac|asia|india)\)\b/i;
const BANGALORE_PATTERN =
  /\b(bangalore|bengaluru|bangalore urban|karnataka)\b/i;
