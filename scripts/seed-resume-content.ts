...
const CONTENT: ResumeData = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: "Skills",
      items: [
        { id: "skills_languages", category: "Languages", skills: ["Python", "Go", "TypeScript", "SQL", "JavaScript", "HTML", "CSS"] },
        { id: "skills_core", category: "Core CS", skills: ["Data Structures", "Algorithms", "OOP", "Operating Systems", "Computer Networks", "RDBMS", "Database Design", "Distributed Systems"] },
        { id: "skills_backend", category: "Backend", skills: ["REST", "Authentication", "RBAC", "PostgreSQL", "Prisma", "Redis", "WebSockets"] },
        { id: "skills_cloud", category: "Cloud / Infrastructure", skills: ["AWS", "Linux", "Docker", "CI/CD", "Monitoring", "Debugging", "Infrastructure Automation"] },
        { id: "skills_tools", category: "Developer Tools", skills: ["Git", "GitHub", "Playwright", "Turborepo", "Bun", "ESLint", "Prettier"] },
        { id: "skills_libs", category: "Libraries / Frameworks", skills: ["FastAPI", "Next.js", "PyTorch", "TensorFlow", "Scikit-learn", "Pandas", "NumPy"] },
      ],
    },
  ],
};
...
const SKILLS = [
  "Python", "Go", "TypeScript", "SQL", "JavaScript", "HTML", "CSS",
  "Data Structures", "Algorithms", "OOP", "Operating Systems",
  "Computer Networks", "RDBMS", "Database Design", "Distributed Systems",
  "REST", "Authentication", "RBAC", "PostgreSQL", "Prisma", "Redis",
  "WebSockets", "AWS", "Linux", "Docker", "CI/CD", "Git", "GitHub",
  "Playwright", "Turborepo", "Bun", "ESLint", "Prettier", "FastAPI",
  "Next.js", "PyTorch", "TensorFlow", "Scikit-learn", "Pandas", "NumPy",
];
